...
const trackPlayerInit = async () => {
 ...
 await TrackPlayer.add({
   id: '1',
   url:
     'https://firebasestorage.googleapis.com/v0/b/rnfirebaseauth-b824b.appspot.com/o/Meditation%2FBreathing%20technique.mp3?alt=media&token=17ee3fa6-7707-4614-8e11-f1451f197f90',
   type: 'default',
   title: 'My Title',
   album: 'My Album',
   artist: 'Rohan Bhatia',
 ...
 return (
  <View style={styles.mainContainer}>
    <View style={styles.imageContainer}>
      <Image
        source={{
          uri: 'https://firebasestorage.googleapis.com/v0/b/rnfirebaseauth-b824b.appspot.com/o/assets%2Fmeditations%2Fbreath.jpg?alt=media&token=a2485659-11ef-4dee-b97f-fe2012e77de4',
        }}
        resizeMode="contain"
