...
const trackPlayerInit = async () => {
 ...
 await TrackPlayer.add({
   id: '1',
   url:
     'https://firebasestorage.googleapis.com/v0/b/rnfirebaseauth-b824b.appspot.com/o/Meditation%2FSea%20sound.mp3?alt=media&token=c77a8f53-598f-4b03-a431-f248dd3a4341',
   type: 'default',
   title: 'My Title',
   album: 'My Album',
   artist: 'Rohan Bhatia',
 ...
 return (
  <View style={styles.mainContainer}>
    <View style={styles.imageContainer}>
      <Image
        source={{
          uri: 'https://firebasestorage.googleapis.com/v0/b/rnfirebaseauth-b824b.appspot.com/o/assets%2Fmeditations%2Fsea.jpg?alt=media&token=3802971b-f9ce-466d-9651-59290c53c6df',
        }}
        resizeMode="contain"
