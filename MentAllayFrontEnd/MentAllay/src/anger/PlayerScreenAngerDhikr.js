...
const trackPlayerInit = async () => {
 ...
 await TrackPlayer.add({
   id: '1',
   url:
     'https://firebasestorage.googleapis.com/v0/b/rnfirebaseauth-b824b.appspot.com/o/Dhikr%2FAnger.mp3?alt=media&token=129f45ea-df61-4880-8067-c8ad52584ec3',
   type: 'default',
   title: 'My Title',
   album: 'My Album',
   artist: 'Rohan Bhatia',
 ...
 return (
  <View style={styles.mainContainer}>
    <View style={styles.imageContainer}>
      <Image
        source={{
          uri: 'https://firebasestorage.googleapis.com/v0/b/rnfirebaseauth-b824b.appspot.com/o/assets%2Fdhikr%2Fdhikr1.jpg?alt=media&token=c847dcae-d607-4a62-856a-2ae580c6ff44',
        }}
        resizeMode="contain"
